				...
				<div class="field half">
					...
					<input type="date" name="dateRecouvrement" id="dateRecouvrement" />
								...
								<div class="field half first">
									...
									<input type="text" name="tva" value="<?php
								...
								<div class="field half">
									...
									<input type="text" name="totalHT" value="<?php 
								...
								<div class="field half first">
									...
									<input type="text" name="montantTVA" value="<?php
									if(isset($_POST['valider2']) AND $_POST['valider2']=='Valider produit'){
								...
								<div class="field half">
									...
									<input type="text" name="totalTTC" value="<?php
									if(isset($_POST['valider2']) AND $_POST['valider2']=='Valider produit'){
