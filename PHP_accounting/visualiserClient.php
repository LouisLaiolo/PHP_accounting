                        ...
                        <!-- AJOUTER CLIENT -->
                            <article id="listeC">
                                ...
                                ?>
                                    ...
                                    <br>
                                    <div id="optionVisu">
                                        <form method="get" action="modifierClient.php#McreerC"><input type="submit" value="Modifier" name="modif"/><input type="hidden" name="id" value="<?php echo($monId);?>"/></form>
                                        <form method="get" action="suppressionClient.php#SuppC"><input type="submit" value="Supprimer" name="supp"/><input type="hidden" name="id" value="<?php echo($monId);?>"/></form>
                                    </div>
